...
banner:
  content: |
    ...
    <a href="https://chibisnorlax.github.io/acnhfaq/island-life/gardening/others/">Visit the current version here.</a>
---
...
|:-:|-|
|<ExternalIcon icon="PltOak" category="MenuIcon" /><br/>Hardwood|• Naturally found on Islands<br/>• Buy saplings from Nook's Cranny|
|<ExternalIcon icon="PltConifer" category="MenuIcon" /><br/>Cedar|• Naturally found on island cliffs.<br/>• Buy saplings from Nook's Cranny|
|<ExternalIcon icon="PltApple" category="MenuIcon" /> <ExternalIcon icon="PltPeach" category="MenuIcon" /> <ExternalIcon icon="PltPear" category="MenuIcon" /> <ExternalIcon icon="PltCherry" category="MenuIcon" /> <ExternalIcon icon="PltCherry" category="MenuIcon" /> <ExternalIcon icon="PltOrange" category="MenuIcon" /><br/>Fruit|• Naturally found on islands.<br/>• Plant fruit to grow|
|<ExternalIcon icon="PltPalm" category="MenuIcon" /><br/>Coconut|• Found on mystery islands.<br/>• Plant coconut to grow.|
|<ExternalIcon icon="PltBamboo" category="MenuIcon" /><br/>Bamboo|• Found on Bamboo Island.<br/>• Plant bamboo to grow.|
|<ExternalIcon icon="PltMoney" category="MenuIcon" /><br/>Money Tree|• Bury bells in glowing spots to grow.|
...
|Shrub|Period|
|:-:|-|
|<ExternalIcon icon="PltBushCamelliaPink" category="MenuIcon" /> <ExternalIcon icon="PltBushCamelliaRed" category="MenuIcon" /><br/>Camellia|NH: Jan 1 - Mar 31<br/>SH: Jun 16 - Sep 30|
|<ExternalIcon icon="PltAzaleaPink" category="MenuIcon" /> <ExternalIcon icon="PltAzaleaWhite" category="MenuIcon" /><br/>Azalea|NH: Apr 11 - May 31<br/>SH: Oct 11 - Nov 30|
|<ExternalIcon icon="PltHydrangeaBlue" category="MenuIcon" /> <ExternalIcon icon="PltHydrangeaPink" category="MenuIcon" /><br/>Hydrangea|NH: Jun 1 - Jul 20<br/>SH: Dec 1 - Jan 20|
|<ExternalIcon icon="PltHibiscusRed" category="MenuIcon" /> <ExternalIcon icon="PltHibiscusYellow" category="MenuIcon" /><br/>Hibiscus|NH: Jul 21 - Sept 20<br/>SH: Jan 21 - Mar 20|
|<ExternalIcon icon="PltBushOsmathusYellow" category="MenuIcon" /> <ExternalIcon icon="PltBushOsmathusOrange" category="MenuIcon" /><br/>Tea Olive|NH: Sept 21 - Oct 31<br/>SH: Mar 21 - Apr 30|
|<ExternalIcon icon="PltHolly" category="MenuIcon" /><br/>Holly|NH: Nov 1 - Dec 31<br/>SH: May 1 - Jun 15|
|<ExternalIcon icon="PltBushPlumeriaPink" category="MenuIcon" /><ExternalIcon icon="PltBushPlumeriaWhite" category="MenuIcon" /><br/>Plumeria|NH: Jun 1 - Sept 20<br/>SH: Dec 1 - Mar 20|
