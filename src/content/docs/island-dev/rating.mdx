...
| Item                                   | Points awarded |
|:---------------------------------------|:---------------|
| Fully grown trees & bamboo[^1] | 1              |
| Fully grown flowers            | 1              |
| Stage 2, 3, 4 crops[^2]        | 1              |
| Crop sprouts[^2]               | 0.5            |
| Flower stems/buds              | 0.7            |
| Flower seeds                   | 0.5            |
| Fully grown bushes[^1]         | 0.5            |
| DIY furniture[^3]              | 0.25           |
| Size 3 DIY furniture[^3]       | 0.75           |
...
[^4]: Bridges only contribute to development points when 2 or more bridges are built, i.e. if only one bridge is built, no points are awarded, and once the second bridge is built, 30 points is awarded for two bridges.
[^5]: These are **not** additive, i.e. you will only get 30 points for 10 villagers, and not 45.
[^6]: Every 30 weeds after having more than 100 weeds will reduce the bonus by one point, the bonus being fully removed with 1,000 weeds or more.
[^7]: Placing more than 6 of the same items in a 8x8 area will incur a point penalty.
[^8]: These are additive, i.e. if an item is an outdoor, size 3 furniture that is priced 20k and above, this means it can contribute a whooping 6.5 development points.
