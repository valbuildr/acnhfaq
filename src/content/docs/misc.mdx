...
banner:
  content: |
    ...
    <a href="https://chibisnorlax.github.io/acnhfaq/misc/">Visit the current version here.</a>
---

import { Aside } from "@astrojs/starlight/components";

## I heard a rumor that X might be added to the game. Is this true?
If Nintendo has not confirmed the feature/item from said rumor, then we cannot confirm if it will be added or not. However, fun and interesting things surface all the time whilst the dataminers are examining the game's code.
