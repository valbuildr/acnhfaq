...
banner:
  content: |
    ...
    <a href="https://chibisnorlax.github.io/acnhfaq/tt/">Visit the current version here.</a>
---
...
<Tabs syncKey="tteffects">
  <TabItem label="Negative Effects">
    - Open plots may fill.
    - Campers will leave.
    - Turnips **will spoil** if you time travel backwards or past 5 AM the following Sunday.
  </TabItem>
  <TabItem label="Positive Effects">
...
<Tabs syncKey="tteffects">
  <TabItem label="Negative Effects">
    ...
    - Villagers may ask/comment on where you have been.[^3]
  </TabItem>
  <TabItem label="Positive Effects">
...
[^3]: This does not affect your frienship with villagers.
...
<dl>
  ...
  <dd>These will append an alphabet to the game's version at the title screen, e.g.
    <code>1.6.0 c</code>. These are usually used for event unlocks.</dd>
  <dt>NTP</dt>
