...
description: "What to do after the player's first week in Animal Crossing: New Horizons."
banner:
  content: |
    This is a <b>preview</b> of a potentially new design for the ACNH Beginner's Guide.
    <a href="https://chibisnorlax.github.io/acnhbeginners/conclusion/">Visit the current version here.</a>
---
...
## Tutorial
- [Day 1](/beginners/walkthrough/day-1/)
- [Day 2](/beginners/walkthrough/day-2/)
- [Day 3](/beginners/walkthrough/day-3/)
- [Day 4](/beginners/walkthrough/day-4/)
- [Day 5-7](/beginners/walkthrough/day-5-7/)
...
![Nook's Cranny base shop](/assets/beginners/nookscranny_1.jpg)

**Nook's Cranny upgraded:**
![Nook's Cranny upgraded](/assets/beginners/nookscranny_2.png)
...
The next upgrade to the museum installs an **art section**. To unlock the museum upgrade you'll need to donate a total of **60 critters/fossils** to [Blathers](/npc/permanent/#blathers). Since you have already donated 20 artifacts in the process of unlocking the museum, you'll need to donate 40 more for a grand total of 60.

See previous days in the tutorial starting [here](/beginners/walkthrough/day-2/) for further guidance.
...
![Redd encounter](/assets/beginners/reddmeeting.jpg)
...
See [here](/npc/visiting/#how-often-does-x-visit-how-do-i-unlock-x-character) for the NPC schedule.
...
## Upgrade the Museum, again! (The Roost)

![A player enjoys a cup of coffe in The Roost with Daisy Mae sitting near them.](/assets/beginners/the_roost.jpg)
...
- The art gallery must be open. If you do not have the art gallery (up the stairs), see [above](#upgrade-the-museum-art-wing).
...
<Aside type="note">
  As of the `2.0.0` update, players who opened their museum **after** this update was released will automatically have the art gallery.
</Aside>
...
<div>
  ...
  <input type="checkbox" class="mr-2"/>
    <label>Obtain all of the <a href="/unlocks/#golden-tool-unlocks-note-spoilers">golden tools</a>.</label> <br/>
  <input type="checkbox" class="mr-2"/>
  ...
  <input type="checkbox" class="mr-2"/>
    <label>Unlock all of the <a href="/island-life/#what-are-reactions">reactions</a>.</label><br/>
  <input type="checkbox" class="mr-2"/>
