...
banner:
  content: |
    ...
    <a href="https://chibisnorlax.github.io/acnhfaq/villagers/mi-mo/">Visit the current version here.</a>
---
...
Note that villager-for-villager trades happen in the same way, but require both players have an extra empty plot to purchase or require [time travel](/tt). 
...
For "normal" campers, no, but you can reset who they chose. Visit https://yuexr.github.io/img/mo/4.png for more detail. [Amiibo](/villagers/amiibo#how-do-i-invite-a-villager-to-live-on-my-island-using-their-amiibo) campers allow you to choose who they replace.