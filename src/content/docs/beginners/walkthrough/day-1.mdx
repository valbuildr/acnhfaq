...
- Tom Nook <ExternalIcon icon="rco" category="NpcIcon" /> (and Timmy <ExternalIcon icon="rcm" category="NpcIcon" /> and Tommy <ExternalIcon icon="rct" category="NpcIcon" />, who you've already become acquainted with)
...
- After all 3 tents are placed, Tom nook will give you some tasks to learn how to gather materials. You will need to collect **10** <ExternalIcon icon="DIYBranch" category="MenuIcon" /> **tree branches** and some fruit!
...
- Completing the **DIY workshop** allows you to learn <ExternalIcon icon="PaperRecipe" category="MenuIcon" /> DIY cards and obtain the DIY Recipes app on your NookPhone. Additionally, you learn the Flimsy Fishing Rod, Flimsy Bug Net, and Campfire DIYs. We recommend you craft both new tools for the next quest.
...
<Aside type="note">
  <ExternalIcon icon="DIYBranch" category="MenuIcon" /> Branches are different from <ExternalIcon icon="DIYWoodNormal" category="MenuIcon" /> wood and come from shaking trees, not axing them.
</Aside>
...
- Once you've caught 5 critters and given them to Tom Nook, he will get a call from [Blathers](/npc/permanent#blathers) <ExternalIcon icon="owl" category="NpcIcon" />. Blathers is the future owner and curator of your island's very own museum!
