...
banner:
  content: |
    ...
    <a href="https://chibisnorlax.github.io/acnhfaq/glitches/">Visit the current version here.</a>
---
...
<Aside type="note">
  Any previously known glitches, if not contained in this list, **have been patched**. This table is current through version <Badge text="2.0.4" variant="tip" />.
</Aside>

| Glitch Name                       | Information                                                                                                                                                       | Fix                                                                                                          |
|------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| Camera OOB                         | Allows the user to access out of bounds areas. Tutorial: https://youtu.be/7lQEwSwX5uk                                                                             | N/A                                                                                                          |
| Cliff Trees                        | Allows the user to place trees on cliff edges. Tutorial: https://youtu.be/YdAzvzHgnKA                                                                             | N/A                                                                                                          |
...
<Aside type="danger">
  ...
  With that in mind, if you still wish to preform the DC dupe, visit https://www.youtube.com/watch?v=qhyHsDs-H3Y for instructions.
</Aside>
