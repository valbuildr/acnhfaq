---
title: "Days 5-7"
description: "A guide for the player's fifth to seventh days in Animal Crossing: New Horizons."
banner:
  content: |
    This is a <b>preview</b> of a potentially new design for the ACNH Beginner's Guide.
    <a href="https://chibisnorlax.github.io/acnhbeginners/day-5-7/">Visit the current version here.</a>
---
...
If you have not completed any of this yet, please see [Day 4](/acnhbeginners/day-4/) for further guidance.
...
- Now that you've furnished the plots, Tom Nook should make an announcement about his **customization workshop**. Customization allows you to change the look of some items.
  - Note that not every item is customizable.
- Customization is relatively straightforward, all you need to do is bring the **item you want to customize** and the required number of <ExternalIcon icon="RemakeKit" category="MenuIcon" host="alexislours.github.io/img" /> **customization kits** to a workbench and select `Customize Something`.
- Tom Nook will give you <ExternalIcon icon="RemakeKit" category="MenuIcon" host="alexislours.github.io/img" /> **50 customization kits** for you to use and experiment with.

### Harvey and his island
- In the next couple days you might see a hippie dog <ExternalIcon icon="spn" category="NpcIcon" host="alexislours.github.io/img" /> walking around your island. Talking to him will prompt him to introduce himself as Harvey (Harv for short) and invite you to visit his island.
...
### Able Sisters
- You may notice with the opening of Nook's Cranny that Mabel <ExternalIcon icon="hgh" category="NpcIcon" host="alexislours.github.io/img" /> now visits every so often.
...
- For more info on Mable, visit [here](/npc/permanent/#mabel). {/* does this link ACTUALLY tell you more info? no. but it looks fancy, so. */}
...
#### Isabelle
- Isabelle <ExternalIcon icon="sza" category="NpcIcon" host="alexislours.github.io/img" /> is an NPC you meet once the upgrade of the Resident Services is complete. Tom Nook will introduce her during announcements and explain that she will take some of his responsibilities.
- Isabelle also adds some new options for you. Visit [here](/npc/permanent/#isabelle) to learn more about Isabelle and what she does. 
...
- Speak to Tom Nook at the construction counter and ask him "What should I do?". He will explain that he has a vision for the island, and that he would like to invite [K.K. Slider](/npc/permanent/#kk-slider) <ExternalIcon icon="tkkA" category="NpcIcon" host="alexislours.github.io/img" /> to perform on your humble island.
...
- The first thing Tom Nook will want you to do is build a campsite. He will give you the DIY for a **Campsite construction kit**, a temporary DIY that you must craft in order to place the campsite. The recipe calls for:
    - 15 <ExternalIcon icon="DIYWoodNormal" category="MenuIcon" host="alexislours.github.io/img" /> **Wood**
    - 15 <ExternalIcon icon="DIYWoodSoft" category="MenuIcon" host="alexislours.github.io/img" /> **Softwood**
    - 15 <ExternalIcon icon="DIYWoodHard" category="MenuIcon" host="alexislours.github.io/img" /> **Hardwood**
    - 15 <ExternalIcon icon="OreIron" category="MenuIcon" host="alexislours.github.io/img" /> **Iron Nuggets**
...
- In 2 days, your campsite will have it's first visitor! This visitor will be a [**smug** villager](/villagers/#what-are-the-villager-personalities) and they are *required* to be invited in order to progress the story.
...
- For more information about autofilled plots, visit [here](/villagers/#what-is-the-voidwhere-do-villagers-that-automatically-fill-my-empty-plots-come-from).
...
- For a complete breakdown of the island rating system, visit [the FAQ](/island-dev/rating/).
